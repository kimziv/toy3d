...
TOY3D_BEGIN_NAMESPACE
    ...
    class ShaderProgramParams
    {
        ...
        private:
            ...
            Bool searchNamedAutoConst( const Uchar *name, Uint* index );
            Bool searchNamedAttrConst( const Uchar *name, Uint* index );
        ...
        public:
            ...
            void updateAttrConstIndex ( Uchar *name, Uint index );
